...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths, T, weights = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, T, weights

    @staticmethod
    def backward(ctx, grad_out_color, _radii, grad_out_depth, grad_out_T, _weights):
